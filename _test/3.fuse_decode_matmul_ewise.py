...
class Module:
    ...
    def decoding(input_ids1: R.Tensor((1, 1), dtype="int32"), all_seq_len: R.Shape(["n"]), kv_cache: R.Tuple(R.Object, R.Object), embedding_weight1: R.Tensor((32000, 4096), dtype="float16"), linear_weight8: R.Tensor((4096, 4096), dtype="float16"), linear_weight9: R.Tensor((4096, 4096), dtype="float16"), linear_weight10: R.Tensor((4096, 4096), dtype="float16"), linear_weight11: R.Tensor((4096, 4096), dtype="float16"), linear_weight12: R.Tensor((11008, 4096), dtype="float16"), linear_weight13: R.Tensor((4096, 11008), dtype="float16"), linear_weight14: R.Tensor((11008, 4096), dtype="float16"), rms_norm_weight3: R.Tensor((4096,), dtype="float16"), rms_norm_weight4: R.Tensor((4096,), dtype="float16"), rms_norm_weight5: R.Tensor((4096,), dtype="float16"), linear_weight15: R.Tensor((32000, 4096), dtype="float16"), cos_cached1: R.Tensor((2048, 128), dtype="float16"), sin_cached1: R.Tensor((2048, 128), dtype="float16")) -> R.Tuple(R.Tensor((1, 1, 32000), dtype="float32"), R.Tuple(R.Object, R.Object)):
        ...
        with R.dataflow():
            ...
            lv1_1 = R.call_tir(cls.fused_decode_matmul1, (lv8, lv9, lv64), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            lv67 = R.call_tir(cls.reshape2, (lv1_1,), out_sinfo=R.Tensor((1, 1, 32, 128), dtype="float16"))
            ...
            lv2_1 = R.call_tir(cls.fused_decode_matmul1, (lv14, lv15, lv64), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            lv70 = R.call_tir(cls.reshape2, (lv2_1,), out_sinfo=R.Tensor((1, 1, 32, 128), dtype="float16"))
            ...
            lv3_1 = R.call_tir(cls.fused_decode_matmul1, (lv20, lv21, lv64), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            lv1_2 = R.call_tir(cls.fused_reshape2_squeeze, (lv3_1,), out_sinfo=R.Tensor((1, 32, 128), dtype="float16"))
            lv80: R.Object = kv_cache[1]
            lv81: R.Object = R.call_packed("vm.builtin.attention_kv_cache_append", lv80, lv1_2, sinfo_args=(R.Object,))
            ...
            lv2_2 = R.call_tir(cls.fused_softmax1_cast1, (lv_1,), out_sinfo=R.Tensor((1, 32, 1, n), dtype="float16"))
            lv97 = R.call_tir(cls.matmul2, (lv2_2, lv88), out_sinfo=R.Tensor((1, 32, 1, 128), dtype="float16"))
            lv3_2 = R.call_tir(cls.fused_transpose3_reshape4, (lv97,), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            ...
            lv_2 = R.call_tir(cls.fused_decode_fused_matmul1_add, (lv26, lv27, lv3_2, lv62), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            lv103 = R.call_tir(cls.rms_norm1, (lv_2, rms_norm_weight4), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            ...
            lv4_1 = R.call_tir(cls.fused_decode1_fused_matmul3_silu, (lv32, lv33, lv103), out_sinfo=R.Tensor((1, 1, 11008), dtype="float16"))
            ...
            lv1_3 = R.call_tir(cls.fused_decode1_fused_matmul3_multiply, (lv38, lv39, lv103, lv4_1), out_sinfo=R.Tensor((1, 1, 11008), dtype="float16"))
            ...
            lv2_3 = R.call_tir(cls.fused_decode2_fused_matmul4_add, (lv44, lv45, lv1_3, lv_2), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            lv113 = R.call_tir(cls.rms_norm1, (lv2_3, rms_norm_weight5), out_sinfo=R.Tensor((1, 1, 4096), dtype="float16"))
            ...
            lv5_1 = R.call_tir(cls.fused_decode3_fused_matmul5_cast2, (lv50, lv51, lv114), out_sinfo=R.Tensor((1, 1, 32000), dtype="float32"))
            gv1: R.Tuple(R.Tensor((1, 1, 32000), dtype="float32"), R.Tuple(R.Object, R.Object)) = lv5_1, (lv79, lv81)
            R.output(gv1)
        return gv1
    ...
    def encoding(input_ids: R.Tensor((1, "n"), dtype="int32"), all_seq_len: R.Shape(["m"]), kv_cache: R.Tuple(R.Object, R.Object), embedding_weight: R.Tensor((32000, 4096), dtype="float16"), linear_weight: R.Tensor((4096, 4096), dtype="float16"), linear_weight1: R.Tensor((4096, 4096), dtype="float16"), linear_weight2: R.Tensor((4096, 4096), dtype="float16"), linear_weight3: R.Tensor((4096, 4096), dtype="float16"), linear_weight4: R.Tensor((11008, 4096), dtype="float16"), linear_weight5: R.Tensor((4096, 11008), dtype="float16"), linear_weight6: R.Tensor((11008, 4096), dtype="float16"), rms_norm_weight: R.Tensor((4096,), dtype="float16"), rms_norm_weight1: R.Tensor((4096,), dtype="float16"), rms_norm_weight2: R.Tensor((4096,), dtype="float16"), linear_weight7: R.Tensor((32000, 4096), dtype="float16"), cos_cached: R.Tensor((2048, 128), dtype="float16"), sin_cached: R.Tensor((2048, 128), dtype="float16")) -> R.Tuple(R.Tensor((1, 1, 32000), dtype="float32"), R.Tuple(R.Object, R.Object)):
        ...
        with R.dataflow():
            ...
            lv_1 = R.call_tir(cls.fused_decode3_fused_matmul5_cast2, (lv110, lv111, lv56_1), out_sinfo=R.Tensor((1, 1, 32000), dtype="float32"))
            gv: R.Tuple(R.Tensor((1, 1, 32000), dtype="float32"), R.Tuple(R.Object, R.Object)) = lv_1, (lv21, lv23)
            R.output(gv)
        return gv
