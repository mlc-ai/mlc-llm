...
def create_embed_tokens_func(
    bb: relax.BlockBuilder, config: LlamaConfig
) -> Dict[int, str]:
    bsz = 1
    seq_len = tvm.tir.Var("n", "int64")
    pidx2pname: Dict[int, str] = {}
    with bb.function("embed_tokens"):
    ...
    mod = bb.get()
    gv = mod.get_global_var("embed_tokens")
...
def get_model(args, hf_config):
    ...
    if (
        ...
        pidx2pname = create_embed_tokens_func(bb, config)
