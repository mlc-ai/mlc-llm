...
### TVM
kernel = batch_spec_verify(num_nodes=num_nodes, vocab=vocab, nbatch=nbatch)
...
tvm.testing.assert_allclose(token_tree_parent_ptr, token_tree_parent_ptr_tvm.asnumpy())
tvm.testing.assert_allclose(token_tree_child_ptr, token_tree_child_ptr_tvm.asnumpy())

time_f = mod.time_evaluator(mod.entry_name, dev, number=10, repeat=3)
res = time_f(
    draft_probs_tvm,
    draft_tokens_tvm,
    model_probs_tvm,
