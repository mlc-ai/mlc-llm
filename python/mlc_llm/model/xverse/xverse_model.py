"""
Implementation for Xverse architecture.
TODO: add docstring
"""
...
class XverseConfig(ConfigBase):  # pylint: disable=too-many-instance-attributes
    """Configuration of the Xverse model."""
    ...
    def __post_init__(self):
        ...
        if self.prefill_chunk_size == 0:
            ...
            self.prefill_chunk_size = min(self.context_window_size, 8192)
        assert self.tensor_parallel_shards == 1, "Xverse currently does not support sharding."


# pylint: disable=invalid-name,missing-docstring


class XverseAttention(nn.Module):  # pylint: disable=too-many-instance-attributes
