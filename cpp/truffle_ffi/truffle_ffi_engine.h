 ...
 */
#ifndef MLC_LLM_TRUFFLE_FFI_JSON_FFI_ENGINE_H_
#define MLC_LLM__FFI_JSON_FFI_ENGINE_H_
 ...
 */
class TruffleFFIEngine {
 public:
  TruffleFFIEngine();

  ~TruffleFFIEngine();

  bool Completion(std::string request_json_str, std::string request_id);
