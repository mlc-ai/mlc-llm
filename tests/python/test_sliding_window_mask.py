...
class SlidingWindowMaskTest(unittest.TestCase):
    ...
    def test_subsequent_prefill_2(self):
        """
        Test 2: chunk size is 3, WS is 5, cache carrying t1 - t5 (t0 is overwritten); input t6, t7, t8.
        """
        bsz = ShapeTuple([1])
        seq_length = ShapeTuple([3])
    ...
    def test_subsequent_prefill_4(self):
        """
        Test 4: chunk size is 5, WS is 3, cache carrying t2-t4 (t0, t1 did not stay in cache); input t5-t9.
        """
        bsz = ShapeTuple([1])
        seq_length = ShapeTuple([5])
    ...
    def test_subsequent_prefill_5(self):
        """
        Test 5: chunk size is 5, WS is 5, cache carrying t5-t9 (t0-t4 overwritten); input t10 (remainder of a prompt).
        Note that this test can also be viewed as a decode. That is, prefilling a chunk of size 1, is the same is decoding.
        """
        bsz = ShapeTuple([1])
    ...
    def test_decode_1(self):
        """
        Test 1: chunk size is 5, WS is 5, cache carrying t5-t9 (t0-t4 overwritten); input t10 (decoding).
        """
        bsz = ShapeTuple([1])
        seq_length = ShapeTuple([1])
        # TODO: MAY DIFFER BY SEMANTICS OF THIS VARIABLE; currently 6, could be 11
