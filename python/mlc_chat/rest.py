        ...
        async def iter_response():
            ...
            async for content in AsyncCompletionStream(generation_config=generation_config):
                if content:
                    ...
                    # This is to handle emojis. An emoji might be made up of multiple tokens. In the Rest streaming setting,
                    # if an emoji gets truncated in the middle of its encoded byte sequence, a replacement character will appear.
