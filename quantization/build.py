...
from quantization.auto_gptq import AutoGPTQForCausalLM, BaseQuantizeConfig
...
def mod_transform_before_build(
    ...
    new_params = model_params if args.quantized_model else utils.transform_params(mod_transform, model_params)
